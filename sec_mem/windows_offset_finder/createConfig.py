...
#===============================================================================
# params:
#    dbs_path: path of VM kernel debug symbols file
# return:
#    dict_lbconf: dict of libvmi configure props
#===============================================================================
def get_basic_libvmi_conf(dbs_path):
    dict_lbconf = {}
        ...
        for line in f:
            ...
            if len(lineSplit) >3:
                if lineSplit[0] == "_EPROCESS" and lineSplit[1] == "ActiveProcessLinks":
                    dict_lbconf["win_tasks"] = lineSplit[2];
                elif lineSplit[0] == "_KPROCESS" and lineSplit[1] == "DirectoryTableBase":
                    dict_lbconf["win_pdbase"] = lineSplit[2];
                elif lineSplit[0] == "_EPROCESS"  and lineSplit[1] == "UniqueProcessId":
                    dict_lbconf["win_pid"] = lineSplit[2];
                elif lineSplit[0] == "_EPROCESS"  and lineSplit[1] == "ImageFileName":
                    dict_lbconf["win_pname"] = lineSplit[2];
                else:
                    pass
    return dict_lbconf                
#get_basic_libvmi_conf("/var/lib/node_ta/sec_mem/tmp/init_win7_debugSysbols.txt")
